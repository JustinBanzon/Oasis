...
public:
    ...
    virtual void Serialize(const Sine<Expression>& negate) = 0;
    virtual void Serialize(const Cosine<Expression>& negate) = 0;
    virtual void Serialize(const Tangent<Expression>& negate) = 0;
